...
translations.en.viewProducts = "View Products";
translations.gu.viewProducts = "ઉત્પાદનો જુઓ";
translations.en.callNow = "Call Now";
translations.gu.callNow = "હવે કૉલ કરો";
translations.en.sendInquiry = "Send Inquiry";
translations.gu.sendInquiry = "ઇનક્વાયરી મોકલો";
translations.en.contactHeadline = "Simple, direct, and ready for business inquiries.";
translations.gu.contactHeadline = "સરળ, સીધો અને વ્યાપારિક પૂછપરછ માટે તૈયાર.";
translations.en.contactHeroDesc = "Share your requirement and our team will respond with product recommendations, pricing, and dispatch availability.";
translations.gu.contactHeroDesc = "તમારી આવશ્યકતા શેર કરો અને અમારી ટીમ પ્રોડક્ટ સૂચનો, કિંમતો અને ડિસ્ટેચ ઉપલબ્ધતા સાથે પ્રતિસાદ આપશે.";
translations.en.factoryOffice = "Factory Office";
translations.gu.factoryOffice = "ફેક્ટરી ઓફિસ";
translations.en.contactSummary = "WORLD FINE BIO CHEMICLES supplies agro chemicals, PGR, fertilizer, water soluble fertilizer, industrial chemicals, solvents, speciality chemicals, glassware, lab chemicals, food colour, and food preservatives.";
translations.gu.contactSummary = "WORLD FINE BIO CHEMICLES કૃષિ રસાયણો, PGR, ખાતર, જળ દ્રાવ્ય ખાતર, શિલ્પ રસાયણો, દ્રાવણો, વિશેષ રસાયણો, કાચ, પ્રયોગશાળા રસાયણો, ખોરાક રંગ અને ખાદ્ય સંરક્ષકો પુરાં પાડે છે.";
translations.en.addressLabel = "Address";
translations.gu.addressLabel = "સરનામું";
translations.en.phoneLabel = "Phone";
translations.gu.phoneLabel = "ફોન";
translations.en.emailLabel = "Email";
translations.gu.emailLabel = "ઈમેલ";
translations.en.workingHoursLabel = "Working Hours";
translations.gu.workingHoursLabel = "કામની સમયસીમા";
translations.en.yourCompanyPlaceholder = "Your company";
translations.gu.yourCompanyPlaceholder = "તમારી કંપની";
translations.en.yourEmailPlaceholder = "you@company.com";
translations.gu.yourEmailPlaceholder = "you@company.com";
translations.en.tellUsYourRequirement = "Tell us your requirement";
translations.gu.tellUsYourRequirement = "તમારી આવશ્યકતા અમને જણાવો";
translations.en.certificationsBlurb = "Add your actual certificates here to strengthen trust with buyers and distributors.";
translations.gu.certificationsBlurb = "ખરીદદારો અને વિતરણકારો સાથે વિશ્વાસ મજબૂત કરવા માટે તમારા વાસ્તવિક પ્રમાણપત્રો અહીં ઉમેરો.";
translations.en.footerAddress = "📍 23, Super India Estate, Behind Relief Hotel, Near Sarkhej - Sanand Chowkdi, Sarkhej, Ahmedabad 15";
translations.gu.footerAddress = "📍 23, સુપર ઇન્ડિયા એસ્ટેટ, રિલિફ હોટેલની પાછળ, સારખેજ - સાનંદ ચોકડીની નજીક, સારખેજ, અમદાવાદ 15";
translations.en.certifications = "Certifications";
translations.gu.certifications = "પ્રમાણપત્રો";
translations.en.certificationsDesc = "Quality documents and compliance details.";
translations.gu.certificationsDesc = "ગુણવત્તા દસ્તાવેજો અને અનુરૂપતા વિગતો.";
translations.en.gstRegistration = "GST / Registration";
translations.gu.gstRegistration = "GST / નોંધણી";
translations.en.gstRegistrationDesc = "Business registration and tax details available for commercial buyers.";
translations.gu.gstRegistrationDesc = "વાણિજ્યિક ખરીદદારો માટે વ્યવસાય નોંધણી અને કર વિગતો ઉપલબ્ધ છે.";
translations.en.coaTestReport = "COA / Test Report";
translations.gu.coaTestReport = "COA / પરીક્ષણ રિપોર્ટ";
translations.en.coaTestReportDesc = "Product quality and test documentation can be shared on request.";
translations.gu.coaTestReportDesc = "ઉત્પાદન ગુણવત્તા અને પરીક્ષણ દસ્તાવેજો વિનંતી પર શેર કરી શકાય છે.";
translations.en.msdsTds = "MSDS / TDS";
translations.gu.msdsTds = "MSDS / TDS";
translations.en.msdsTdsDesc = "Material safety and technical data sheets for selected products.";
translations.gu.msdsTdsDesc = "પસંદ કરાયેલા ઉત્પાદનો માટે સામગ્રી સલામતી અને તકનીકી ડેટા શીટ.";
translations.en.complianceFiles = "Compliance Files";
translations.gu.complianceFiles = "અનુપાલન ફાઇલો";
translations.en.complianceFilesDesc = "Support documents for safe handling, storage, and dispatch.";
translations.gu.complianceFilesDesc = "સુરક્ષિત હાથવગ, સ્ટોરેજ અને ડિસ્પેચ માટે સહાય દસ્તાવેજો.";
    ...
    if (node.children.length === 0) {
      ...
      if (normalizedText) {
        for (let i = 0; i < keys.length; i++) {
          const k = keys[i];
          const enVal = (translations.en[k] || '').trim().replace(/\s+/g, ' ');
          const guVal = (translations.gu[k] || '').trim().replace(/\s+/g, ' ');
          if (normalizedText === enVal || normalizedText === guVal) {
...
function updateLanguageToggle() {
  ...
  if (toggle) {
    ...
    toggle.title = label;
    toggle.setAttribute('aria-pressed', currentLanguage === 'gu' ? 'true' : 'false');
    toggle.classList.toggle('active', currentLanguage === 'gu');
    toggle.classList.toggle('inactive', currentLanguage === 'en');
  }
}
